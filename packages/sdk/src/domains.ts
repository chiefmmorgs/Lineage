...
export class DomainsModule {
   ...
   * ```
   */
  async resolve(name: string): Promise<DomainResolution> {
   ...
   */
  async resolveEns(name: string): Promise<DomainResolution> {
    try {
   ...
   */
  async resolveBasename(name: string): Promise<DomainResolution> {
    try {
